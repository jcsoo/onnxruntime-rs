...
impl COREMLFlags {
    pub const COREML_FLAG_LAST: COREMLFlags = COREMLFlags::COREML_FLAG_ONLY_ENABLE_DEVICE_WITH_ANE;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum COREMLFlags {
...
extern "C" {
    pub fn OrtSessionOptionsAppendExecutionProvider_CoreML(
        options: *mut OrtSessionOptions,
        coreml_flags: u32,
    ) -> OrtStatusPtr;
}
